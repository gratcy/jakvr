...
$('#elem-FrontColumns_navigation01-1464773953300 ul> li:eq(6) a').addClass("current");
})
</script>
    <!-- InstanceEndEditable --> 
  </head>  
...
<div id="FrontColumns_navigation01-1464773953300" class="FrontColumns_navigation01-d2_c1"><div id="d2menubar_FrontColumns_navigation01-1464773953300" class="mattblackmenu">
	...
	<p>
		<span style="font-size: 24px;">Contact Name :</span></p>
	<p>
		Adry Sunarto<br />
		&nbsp;</p>
	<p>
		<span style="font-size: 24px;">Contact Telephone：</span></p>
	<p>
		+62 817 190 021<br />
		&nbsp;</p>
	<p>
		<span style="font-size: 24px;">Work hours：</span></p>
	<p>
		Monday to Saturday&nbsp; 9:00-22:00<br />
		&nbsp;</p>
	<p>
		<span style="font-size: 24px;">E-mail：</span></p>
	<p>
		Business E-mail：<a href="mailto:adrysunarto@jakvr.com">adrysunarto@jakvr.com</a></p>
</div>
</div>
		</div>
  </div>

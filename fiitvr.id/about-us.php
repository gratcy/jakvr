...
$('#elem-FrontColumns_navigation01-1464773953300 ul> li:eq(5) a').addClass("current");
})
</script>
    <!-- InstanceEndEditable --> 
<script>
	...
	<a href="/" target="_self" >Home</a>
  	...
  	<div class="describe htmledit">
  		<div class="FrontComContent_detail01-1465181351839_htmlbreak" id="FrontComContent_detail01-1465181351839_cont_1"
				style="display: block;"><div id="contactcs">
	<p>
		<span style="font-size: 24px;">Tentang Kami</span></p>
		<p>&nbsp;</p>
	<p>
Kami bukan official FiitVR, melainkan kami hanyalah penjual dan distributor Fiit VR Indonesia. Kami menjual produk-produk fiitvr di melalui online maupun offline.</p>
</div>
</div>
		</div>
  </div>
...
-->
              <a href="https://www.facebook.com/Jakvrcom/" target="_blank" class="jiathis_button_fb" title="Share on Facebook"><span class="jiathis_txt jtico jtico_fb"></span></a>  
              <a href="https://plus.google.com/+JakvrGadget" target="_blank" class="jiathis_button_google" title="Share on Google"><span class="jiathis_txt jtico jtico_google"></span></a>    
              <a href="https://www.instagram.com/jakvr/" target="_blank" class="jiathis_button_tsina" title="Share on Instagram"><span class="jiathis_txt jtico jtico_tsina"></span></a>
            </div>  

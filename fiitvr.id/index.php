...
<title>Kacamata FiiT VR - Fiit VR Indonesia</title>
...
<meta name="description" content="FiitVR Kacamata VR Terbaik. Jual Kacamata VR murah. Virtual Reality, FiitVR Solusinya."/>  
<meta name="copyright" content="深圳二愣子科技有限公司">
<link href="./assets/lib.min.css?<?php echo time();?>" rel="stylesheet" type="text/css">
<link href="./assets/page_index.min.css?<?php echo time();?>" rel="stylesheet" type="text/css">
...
<!-- LightBox 开始 -->
<link href="./assets/lightbox.css?<?php echo time();?>" type="text/css" rel="stylesheet">
...
$(function(){
$("#elem-FrontPublic_slideShow01-1466645242359 .fullSlide .bd LI:eq(0) a").each(function(){
...
<div id="change">
	...
	<div class="topiconimg">
       ...
       <a href="http://fiitvr.id/"><img src="./assets/logo.png"></a> <script>
      ...
      <div id="box_main"> 
        ...
        <div id="box_left"> 
          <div id="box_left_sub1"> 
            <div xmlns="" class="columnSpace" id="elem-FrontPublic_slideShow01-1466645242359" name="公用幻灯">
              <script language="javascript">
	//<![CDATA[
	
		FrontPublic_slideShow01['FrontPublic_slideShow01-1466645242359_init'] = function (){
		 FrontPublic_slideShow01['FrontPublic_slideShow01-1466645242359_init'] = new FrontPublic_slideShow01();
		 FrontPublic_slideShow01['FrontPublic_slideShow01-1466645242359_init'].d5_slide("960","");
		}
		$( FrontPublic_slideShow01['FrontPublic_slideShow01-1466645242359_init']);

	
	// ]]>
</script>  
<script type="text/javascript" src="./assets/superslide.2.1.js"></script>
<div id="FrontPublic_slideShow01-1466645242359" class="FrontPublic_slideShow01-d6_c1"><div class="fullSlide">
	<div class="bd">
		<ul style="position: relative; width: 960px; height: 800px;">
       <li style="position: absolute; width: 1920px; display: list-item;">
        			<a href="javascript:void(0)?lightbox[iframe]=true&amp;lightbox[width]=600&amp;lightbox[height]=345" class="f_pic" rel="group">
		       	  			<img src="./assets/ad95462a-4124-456c-bc3e-b3dd6c92a23e.jpg">
		       	  			</a>
		       	  			
		       	  			<a href="javascript:void(0)?lightbox[iframe]=true&amp;lightbox[width]=600&amp;lightbox[height]=345" class="f_title" rel="group">
		       	  			</a>
						</li>     
			
				
	   <li style="position: absolute; width: 1920px; display: none;">
        			<a href="http://fiitvr.id/fiitvr-pro2s" class="f_pic" target="_blank">
						<img src="./assets/af820e57-15de-4eb0-a1c9-1b68f2396ebf.jpg">
		       	  			</a>
						
		       	  			<a href="http://fiitvr.id/fiitvr-pro2s" class="f_title" target="_blank">
	   ...
	   <li style="position: absolute; width: 1920px; display: none;">
        			<a href="http://fiitvr.id/resource" class="f_pic" target="_blank">
						<img src="./assets/e0a12b93-32a3-4da9-ba5f-df420e40dbaf.jpg">
		       	  			</a>
						
		       	  			<a href="http://fiitvr.id/resource" class="f_title" target="_blank">
    ...
    startFun: function(i) {
        ...
        if ( !! curLi.attr("_src")) {
          ...
          <div id="box_left_sub2"> 
            <div xmlns="" class="columnSpace" id="elem-FrontSpecifies_show01-1464774398061" name="说明页">  
              <div id="FrontSpecifies_show01-1464774398061" class="FrontSpecifies_show01-d3_c1"><div class="describe htmledit">
       <div id="indexpic1">
	<a href="http://fiitvr.id/fiitvr-pro2n"><img src="./assets/index_pic1.png"></a></div>
<div id="indexpic2">
	<a href="http://fiitvr.id/fiitvr-pro2s"><img src="./assets/c7feb689-9d18-477f-8e56-87f960b8b047.png" style="width: 800px; height: 265px;"></a></div>
<div id="indexpic3">
	<a href="http://fiitvr.id/fiitvr-pro3f"><img src="./assets/c85a676c-1ea2-452a-911d-d345c2ccabf4.png" style="width: 800px; height: 265px;"></a></div>
<div id="indexpic4">
	<a href="http://fiitvr.id/resource"><img src="./assets/index_pic3.png" style="width: 800px; height: 265px;"></a></div></div>
</div> 
            </div>
          </div> 
        </div>  

...
<title>BOBOVR 3D VR Glasses Virtual Reality - BoboVR Indonesia</title>
<meta name="Keywords" content="Jual BoboVR Murah, VR, Virtual Reality, Google Cardboard, Oculus Rift, Smartphone VR, Smartphone" />
<meta name="description" content="Jual BoboVR Murah. Virtual Reality Google Cardboard Oculus Rift Gear VR" />
<link rel="shortcut icon" href="/favico.ico" type="image/x-icon">
<link rel="bookmark" href="/favico.ico">
<link type="text/css" href="/assets/style.css?<?php echo time(); ?>" rel="stylesheet" />
<link type="text/css" href="/assets/bootstrap.min.css" rel="stylesheet" />
<script type="text/javascript" src="/assets/jquery.js"></script>
<script type="text/javascript" src="/assets/bootstrap.min.js"></script>
<style type="text/css">
.flexslider { position: relative; height: 646px; background: url(assets/img/loading.gif) 50% no-repeat;}
.slides { position: relative; z-index: 1;}
.slides li { height: 646px;}
.flex-control-nav { position: absolute; bottom:50px; z-index: 2; width: 100%; text-align: center;}
.flex-control-nav li { display: inline-block; width: 97px; height: 4px; margin: 0 8px; *display: inline; zoom: 1;}
.flex-control-nav a { display: inline-block; width: 97px; height: 4px; line-height: 40px; overflow: hidden; background: url(assets/img/dot.png) right 0 no-repeat; cursor: pointer;}
.flex-control-nav .flex-active { background-position: 0 0;}
.main-content{width:100%; height:auto; margin:0 auto;}
</style>
</head>
<script>
...
<div class="flexslider">
    <ul class="slides">
         <li style="top:50px;background:url(assets/img/z5_banner01.jpg);background-repeat:no-repeat;background-size:cover;background-position:center center;position:absolute;width:100%"><a href="http://bobovr.id/z5" title="BOBOVR Z5" target="_blank"><div style="height:646px; margin:0 auto;"></div></a></li>
    </ul>
</div>
<script>
$(window).on('load', function() {
    //~ $('.flexslider').flexslider({
        ...
        //~ pauseOnAction: false
    //~ });
    //~ $('li[_t_nav="etalase"] > h2 > a').bind('click hover',function(){
		//~ $('div#etalase').show();
	//~ });
});
</script>
...
<!--菜单 开始-->
<br />
<div class="index_menu index_menuen">
       <div class="main-content">
    <div class="container">
        <div class="content-1">
            <h1  style="line-height:70px;font-size:28px;">New Arrival</h1>
            <div class="services">
                ...
                <ul>
                    <li>
                        <div class="thumbnail danhui col-xs-11">
                            <p class="label-danger new">hot</p>
                            <a style="outline: medium none;" title="BOBOVR Z5" hidefocus="true" href="http://bobovr.id/z5"><img data-src="holder.js/100%x200" alt="100%x200" src="http://bobovr.id/assets/img/allstar_z51.png" data-holder-rendered="true" display:="" block;="" height="117" width="133"></a>
                            <div class="caption">
                                <h5> BOBOVR Z5</h5>
                                <p class="ContactText" style="font-size:15px;"> Future and Reachable</p>
                                <p><a style="outline: medium none;" title="BOBOVR Z5" hidefocus="true" href="http://bobovr.id/z5" class="price">More</a></p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="thumbnail danhui col-xs-11">
                            <p class="label-danger new">New</p>
                            <a style="outline: medium none;" title="BOBOVR X1" hidefocus="true" href="http://bobovr.id/x1"><img data-src="holder.js/100%x200" alt="100%x200" src="http://bobovr.id/assets/img/allstar_x2.png" data-holder-rendered="true" display:="" block;="" height="117" width="133"></a>
                            <div class="caption">
                                <h5>BOBOVR AIO</h5>
                                <p class="ContactText" style="font-size:15px;">Extremlly immersion on audio and visual</p>
                                <p><a style="outline: medium none;" title="BOBOVR X1" hidefocus="true" href="http://bobovr.id/x1" class="price">More</a></p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="thumbnail danhui col-xs-11">
                            <p class="label-danger new">hot</p>
                            <a style="outline: medium none;" title="BOBOVR Z4 Mini" hidefocus="true" href="http://bobovr.id/z4-mini"><img data-src="http://bobovr.id/assets/img/Z4-mini-45_05.png" alt="BoboVR z4-mini" src="http://bobovr.id/assets/img/Z4-mini-45_05.png" data-holder-rendered="true" display:="" block;="" height="117" width="133"></a>
                            <div class="caption">
                                <h5> BOBOVR Z4 Mini </h5>
                                <p class="ContactText" style="font-size:15px;">Visual immersion VR headset  </p>
                                <p><a style="outline: medium none;" title="BOBOVR Z4 Mini" hidefocus="true" href="http://bobovr.id/z4-mini" class="price">More</a></p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="thumbnail danhui col-xs-11">
                            <p class="label-danger new">Hot</p>
                            <a style="outline: medium none;" title="BOBOVR Z4" hidefocus="true" href="http://bobovr.id/bobovr-z4/" target="_blank"><img data-src="holder.js/100%x200" alt="100%x200" src="/assets/img/allstar_z4.jpg" data-holder-rendered="true" display:="" block;="" height="117" width="133"></a>
                            <div class="caption">
                                <h5>BOBOVR Z4</h5>
                                <p class="ContactText" style="font-size:15px;">Audio + Visual immersion VR headset</p>
                                <p><a style="outline: medium none;" title="BOBOVR Z4" hidefocus="true" href="http://bobovr.id/bobovr-z4/" class="price">More</a></p>
                            </div>
                        </div>
                    </li>
                    </ul>

...
<title>VR Download - BoboVR Indonesia</title>
<meta name="Keywords" content="Jual BoboVR Murah, BoboVR Z4, Z4 Mini, VR, Virtual Reality, Google Cardboard, Oculus Rift, Smartphone VR, Smartphone, Download Software BoboVR" />
<meta name="description" content="Download BoboVR Application and Games Virtual Reality Google Cardboard" />
...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
	...
	<div class="navigation-down">
		...
		<div id="solution" class="nav-down-menu menu-3 menu-1" style="display: block;" _t_nav="solution">
			<div class="navigation-down-inner">
				<ul class="menu_xial">
...
<div class="down_bg">
	<div class="down_bga">
        ...
        <div class="down_title">
          <h3>Partner Strategik</h3>
          <p>BOBOVR Kerjasama</p>
        </div>
        <!--标题 结束-->
        ...
        <div class="down_con">
        	<ul>
                  <li>
                      <a href="http://trinusvr.com/"><img src="/assets/img/1.jpg" /></a>
                      <p><a href="http://trinusvr.com/">TrinusVR</a></p>
                  </li>
                  <li>
                      <a href="https://play.google.com/store/search?q=vr&c=apps&hl=en"><img src="/assets/img/2.jpg" /></a>
                      <p><a href="https://play.google.com/store/search?q=vr&c=apps&hl=en">Google cardboard</a></p>
                  </li>
                  <li>
                      <a href="https://itunes.apple.com/us/app/google-cardboard/id987962261"><img src="/assets/img/3.jpg" /></a>
                      <p><a href="https://itunes.apple.com/us/app/google-cardboard/id987962261">IOS Google Cardboard</a></p>
                  </li>
          	</ul>
        </div>
    	<!--内容 结束-->
        <div class="down_kong"></div>
        <!--标题 开始-->
        <div class="down_title">
          <h3 class="wd">IOS(iPhone)</h3>
          <p>iOS | Game Sumber Download </p>
        </div>
        <!--标题 结束-->
        ...
        <div class="down_con">
        	<ul>
                  <li>
                      <a href="https://itunes.apple.com/us/app/vr-roller-coaster-simulator/id1029391378"><img src="/assets/img/4.jpg" /></a>
                      <p><a href="https://itunes.apple.com/us/app/vr-roller-coaster-simulator/id1029391378">VR Roller Coaster Simulator 3D</a></p>
                  </li>
                  <li>
                      <a href="https://itunes.apple.com/us/app/vr-flappy-for-google-cardboard/id1008080998"><img src="/assets/img/5.jpg" /></a>
                      <p><a href="https://itunes.apple.com/us/app/vr-flappy-for-google-cardboard/id1008080998">VR Flappy</a></p>
                  </li>
                  <li>
                      <a href="http://bobovr.id/ios-bantuan" target="_blank"><img src="/assets/img/ios_help.jpg" /></a>
                      <p><a href="http://bobovr.id/ios-bantuan" target="_blank">IOS Bantuan Dokumentasi</a></p>
                  </li>
          	</ul>
        </div>
    	<!--内容 结束-->
        ...
        <!--标题 开始-->
        <div class="down_title">
          <h3 class="wd">Android</h3>
          <p>Android | Game Sumber Download</p>
        </div>
        <!--标题 结束-->
        ...
        <div class="down_con">
        	<ul>
                  <li>
                      <a href="https://play.google.com/store/apps/details?id=com.frag.vrrollercoaster&hl=en"><img src="/assets/img/7.jpg" /></a>
                      <p><a href="https://play.google.com/store/apps/details?id=com.frag.vrrollercoaster&hl=en">VR Roller Coaster</a></p>
                  </li>
                  <li>
                      <a href="https://play.google.com/store/apps/details?id=com.google.samples.apps.cardboarddemo&hl=en"><img src="/assets/img/8.jpg" /></a>
                      <p><a href="https://play.google.com/store/apps/details?id=com.google.samples.apps.cardboarddemo&hl=en">Cardboard</a></p>
                  </li>
                  <li>
                      <a href="http://bobovr.id/android-bantuan" target="_blank"><img src="/assets/img/android_help.jpg" /></a>
                      <p><a href="http://bobovr.id/android-bantuan" target="_blank">Android Bantuan Dokumentasi</a></p>
                  </li>
          	</ul>
        </div>
    	<!--内容 结束-->

...
<title>BOBOVR S2 - BoboVR Indonesia</title>
<meta name="Keywords" content="BOBOVR S2, Jual BoboVR Murah, VR, Virtual Reality, Google Cardboard, Oculus Rift, Smartphone VR, Smartphone" />
<meta name="description" content="Jual BoboVR S2 Murah. Virtual Reality Google Cardboard Oculus Rift Gear VR" />
...
$(function(){	
    $("#demo3").jcSlider({
		speed:"easeInOutExpo",
		loadPath:'assets/img/loading.gif',
		Default : 1,
		setMode:'x',
		autoPlay:true,
		autoTime:2000, 
...
<style type="text/css">
.flexslider { position: relative; height: 941px; overflow: hidden; background: url(assets/img/loading.gif) 50% no-repeat;}
.slides { position: relative; z-index: 1;}
.slides li { height: 941px;}
	...
	<div class="navigation-up">
		...
		<div class="collapse navigation-v3 navbar-collapse">        
			<ul class="nav navbar-nav navbar-right">
					...
					<li class="nav-up-selected-inpage" _t_nav="">
						<h2>
...
<p>&nbsp;</p>
<div class="clear"></div>
	<div style="text-align:center"><h1>BoboVR S2</h1></div>
<p>&nbsp;</p>
<p>&nbsp;</p>
<div class="clear"></div>
<div style="width: 100%;"><img style="width: 100%;" src="product/e1.jpg" /></div>
<div style="width: 100%;"><img style="width: 100%;" src="product/e2.jpg" /></div>
<div style="width: 100%;"><img style="width: 100%;" src="product/e3.jpg" /></div>
<div style="width: 100%;"><img style="width: 100%;" src="product/e4.jpg" /></div>
<div style="width: 100%;"><img style="width: 100%;" src="product/e5.jpg" /></div>
<div style="width: 100%;"><img style="width: 100%;" src="product/e6.jpg" /></div>
<div style="width: 100%;"><img style="width: 100%;" src="product/e7.jpg" /></div>
<div style="width: 100%;"><img style="width: 100%;" src="product/e8.jpg" /></div>
<div style="width: 100%;"><img style="width: 100%;" src="product/e9.jpg" /></div>
<div style="width: 100%;"><img style="width: 100%;" src="product/e10.jpg" /></div>
<div style="width: 100%;"><img style="width: 100%;" src="product/e11.jpg" /></div>
<p>&nbsp;</p>
<div style="width: 100%;margin: auto;padding:20px">
<h2>BoboVR S2 Spesifikasi Kamera</h2>
<table border="0" style="width:100%">
<tr><td>Nama</td><td>: VR Kamera S2</td></tr>
<tr><td>Model</td><td>: S2</td></tr>
<tr><td>Kamera</td><td>: 2560 x 960</td></tr>
<tr><td>Daya Power</td><td>: 5V</td></tr>
<tr><td>FPC</td><td>: 30F/S</td></tr>
<tr><td>Lensa</td><td>: High-precision Glass Lens</td></tr>
<tr><td>Sensor</td><td>: CMOS</td></tr>
<tr><td>Dukungan</td><td>: USB 2.0</td></tr>
<tr><td>Daya Kerja</td><td>: 220mA</td></tr>
</table>
</div>
<p>&nbsp;</p>
<!--底部 开始-->

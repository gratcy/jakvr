...
<title>Android Bantuan Dokumentasi</title>
<meta name="Keywords" content="BOBOVR X1, BoboVR Z4, Z4 Mini, Jual BoboVR Murah, VR, Virtual Reality, Google Cardboard, Oculus Rift, Smartphone VR, Smartphone" />
<meta name="description" content="Android Bantuan Dokumentasi untuk semua produk BoboVR" />
...
<!--banner 开始-->
<div class="android_banner">
	<div class="android_bannera">
    	<div class="android_banneral"><img src="http://www.bobovr.com/skin/default/images/android_shouji.png" /></div>
        <div class="android_bannerar">
            <h1>Android</h1>
            <h4>sumber download</h4>
            <p>Cari "VR" atau "VR Player" di Android app market atau Google Play dan anda dapat mencari VR games dan VR panoramic video player. Atau scan dan cari QR code di VR resources.</p>
            <div class="ios_banneralbtn"><a href="https://play.google.com/store" target="_blank"><div class="ios_banneralbtna">Google  Play</div></a></div>
        </div>
...
<div class="ios_content">
	<div class="ios_contenta">
    
    	<div class="ios_bza">
        	<div class="ios_bzal"><img src="http://www.bobovr.com/skin/default/images/android_imga.jpg" /></div>
            <div class="ios_bzar">
            	<h3 class="ios_bzatitle">STEP 1</h3>
                <p class="ios_bzap">
                	Masuk Google play, klik Apps. <br /><br />
                	<a href="https://play.google.com/store" target="_blank">https://play.google.com/store</a>
                </p>
            </div>
        </div>
    	...
    	<div class="ios_bza">
        	<div class="ios_bzaal">
            	<h3 class="ios_bzatitle">STEP 2</h3>
                <p class="ios_bzap">
                	Masuk Google applications market APP download. <br /><br />
					<a href="https://play.google.com/store/apps" target="_blank">https://play.google.com/store/apps</a>
                </p>
            </div>
            <div class="ios_bzaar"><img src="http://www.bobovr.com/skin/default/images/android_imgb.jpg" /></div>
        </div>
    
    	<div class="ios_bza">
        	<div class="ios_bzal"><img src="http://www.bobovr.com/skin/default/images/android_imgc.jpg" /></div>
            <div class="ios_bzar">
            	<h3 class="ios_bzatitle">STEP 3</h3>
                <p class="ios_bzap">Cari "VR" key , anda dapat mencari banya VR applications. Klik aplikasi lalu download.</p>
            </div>
        </div>
    
    	<div class="ios_bza">
        	<div class="ios_bzaal">
            	<h3 class="ios_bzatitle">STEP 4</h3>
                <p class="ios_bzap">Masuk dan pilih aplikasi, kemudian klik dan install.</p>
            </div>
            <div class="ios_bzaar"><img src="http://www.bobovr.com/skin/default/images/android_imgd.jpg" /></div>
        </div>
        
        <div class="android_fontb">
        	<p>Masuk Google play melalui komputer anda untuk download aplikasi, anda harus login akun google dan pastikan handphone anda konek ke komputer. Jika anda telah berhasil install aplikasi di handphone anda melalui Google market,  anda dapat mencari "VR" key  secara langsung melalui aplikasi mobile Android Market dan download.</p>
        </div>

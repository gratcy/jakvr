<?php
$str = file_get_contents('http://jakvr.com/jak-api/get_search_results/?search=bobovr');
...
$posts = array();
for($i=1;$i<=$pages;++$i) {
	$str = file_get_contents('http://jakvr.com/jak-api/get_search_results/?search=bobovr&page=' . $i);

...
<title>IOS Bantuan Dokumentasi</title>
...
<meta name="description" content="IOS Bantuan Dokumentasi untuk semua produk BoboVR" />
...
<!--banner 开始-->
<div class="ios_banner">
	<div class="ios_bannera">
        <div class="ios_banneral">
            <h1>IOS</h1>
        ...
        <div class="ios_bannerar"><img src="http://www.bobovr.com/skin/default/images/ios_shouji.png" /></div>
    </div>
</div>
<!--banner 结束-->
...
<div class="ios_content">
	<div class="ios_contenta">
    	...
    	<div class="ios_bza">
        	<div class="ios_bzal"><img src="http://www.bobovr.com/skin/default/images/ios_imga.jpg" style="border:none;" /></div>
            <div class="ios_bzar">
            	<h3 class="ios_bzatitle">STEP 1</h3>
                <p class="ios_bzap">Pilih menu App Store pada handphone anda.</p>
            </div>
        </div>
    	...
    	<div class="ios_bza">
        	<div class="ios_bzaal">
                ...
                <p class="ios_bzap">Buka App Store lalu pilih menu search.</p>
            </div>
            <div class="ios_bzaar"><img src="http://www.bobovr.com/skin/default/images/ios_imgb.jpg" style="border:none;" /></div>
        </div>
    
    	<div class="ios_bza">
        	<div class="ios_bzal"><img src="http://www.bobovr.com/skin/default/images/ios_imgc.jpg" /></div>
            <div class="ios_bzar">
            	<h3 class="ios_bzatitle">STEP 3</h3>
                <p class="ios_bzap">Cari "VR" pada menu pencarian.</p>
            </div>
        </div>
    	...
    	<div class="ios_bza">
        	<div class="ios_bzaal">
                ...
                <p class="ios_bzap">Ada banyak aplikasi VR yang dapat anda gunakan. Anda bisa memilihnya sesuai kebutuhan anda.</p>
            </div>
            <div class="ios_bzaar"><img src="http://www.bobovr.com/skin/default/images/ios_imgd.jpg" /></div>
        </div>

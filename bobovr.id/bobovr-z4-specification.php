...
<title>BOBOVR Z4 Specification - BoboVR Indonesia</title>
<meta name="Keywords" content="BOBOVR Z4, Jual BoboVR Murah, VR, Virtual Reality, Google Cardboard, Oculus Rift, Smartphone VR, Smartphone" />
<meta name="description" content="Specification BoboVR Z4. Virtual Reality Google Cardboard Oculus Rift Gear VR" />
...
.nav-tabs li a{ color:#767676; padding-left:19px; padding-top:5px; padding-bottom:5px; border:none; border-radius:0;}
.nav-tabs li a:hover{ color:#75a208; padding-left:19px; border-left:1px solid #75a208; background:none;}
.nav-tabs>li.active>a,.nav-tabs>li.active>a:focus,.nav-tabs>li.active>a:hover{ color:#75a208; padding-left:19px; border-left:1px solid #75a208; border-right:none; border-top:none; border-bottom:none;}
	...
	<div class="navigation-up">
		...
		<div class="collapse navigation-v3 navbar-collapse">        
			<ul class="nav navbar-nav navbar-right">
					...
					<li class="nav-up-selected-inpage" _t_nav="product">
						<h2>
...
<div class="cs_cont">
	<div class="cs_conta">
        ...
        <div class="cs_contal">
        	<!--1 开始-->
            <div id="cs_a1" class="cs_cczl">
            	<div class="cs_cczll"><h2>Ukuran dan <br /> Berat</h2></div>
            	<div class="cs_cczlr">
                	<img src="/assets/img/z4_canshu.jpg"  style="margin-left:-80px;"/>
                    <ul>
                    	<li>Net berat: 410g</li>
                    	<li>Contoh ukuran paket : 235 * 225 * 145mm</li>
                        <li>Contoh berat: 700g</li>
                    </ul>
                </div>
            </div>
            <!--1 结束-->
        	...
        	<!--2 开始-->
            <div id="cs_a2" class="cs_cczl">
            	<div class="cs_cczll"><h2>Kaca</h2></div>
            	<div class="cs_cczlr">
                	<ul>
                    	<li>Kaca material: Lensa optik kualitas tinggi jepang</li>
                    	<li>Kaca diameter: 42mm</li>
                        <li>Sudut Visual: max 120° (Terkait dengan ukuran handphone dan head strap tightness)</li>
                        <li>Optidress: Desain aspherical </li>
                        <li>Penyimpangan warna: 0.39mm</li>
                    </ul>
                </div>
            </div>
            <!--2 结束-->
        	...
        	<!--3 开始-->
            <div id="cs_a3" class="cs_cczl">
            	<div class="cs_cczll"><h2>Visual Kontrol</h2></div>
            	<div class="cs_cczlr">
                	<ul>
                    	<li>Short-sighted: 0-800°</li>
                        <li>Far-sighted: 0-500°</li>
                    	<li>Pupil Distance Adjust: 58-68mm</li>
                    </ul>
                </div>
            </div>
            <!--3 结束-->
        	...
        	<!--4 开始-->
            <div id="cs_a4" class="cs_cczl">
            	<div class="cs_cczll"><h2>Audio sistem</h2></div>
            	<div class="cs_cczlr">
                	<ul>
                    	<li>Earphone kepekaan: 98 dB</li>
                        <li>Jarak Frekuansi: 20 – 20,000Hz</li>
                        <li>MAX power: 50mW</li>
                        <li>Standar Eksekutif: GB/T 14471-2013</li>
                        <li>Earmuff: Highness kesetiaan audio earmuff x 1</li>
                    </ul>
                </div>
            </div>
            <!--4 结束-->
        	...
        	<!--5 开始-->
            <div id="cs_a5" class="cs_cczl">
            	<div class="cs_cczll"><h2>Dukungan telepon</h2></div>
            	<div class="cs_cczlr">
                	<ul>
                    	<li>Ukuran layar: 4.7-6.2 inch (lihat panjang dan lebar berikut)</li>
                    	<li>Ukuran telepon: 160*85mm /  dalam 163*82mm</li>
                    	<li>Referensi Ukuran telepon: 5.5-6.0inch，resolution 1080p-2k</li>
                    </ul>
                </div>
            </div>
            <!--5 结束-->
        	...
        	<!--6 开始-->
            <div id="cs_a6" class="cs_cczl">
            	<div class="cs_cczll"><h2>Dukungan Bluetooth<br />(optional)</h2></div>
            	<div class="cs_cczlr">
                	<ul>
                    	<li>Dukungan 3.0 standar wireless</li>
                    	<li>Sangat sensitif rocking bar, respon seperdetik</li>
                    	<li>Konfirmasikan, kembali, suara tombol atas dan bawah, tombol multifungsi gigi biru, power on dan off / fungsi mouse Android</li>
                    	<li>Key life-span 200,000 kali</li>
                    	<li></li>
                    </ul>
                </div>
            </div>
        	...
        	<!--7 开始-->
            <div id="cs_a7" class="cs_cczl">
            	<div class="cs_cczll"><h2>Body material</h2></div>
            	<div class="cs_cczlr">
                	<ul>
                    	<li>Body: high strength ABS+PC material</li>
                    	<li>Headstrap: TPU+ lycra, Lulus uji kekuatan tarik perban 5KG/5 detik</li>
                    	<li>Kontak wajah: Advanced flocking, Anti alergi dan bernapas dan anti keringat; Detachable design, mudah dibersihkan dan digunakan kembali</li>
                        <li></li>
                    </ul>
                </div>
            </div>
        	...
        	<!--7 开始-->
            <div class="cs_cczl">
            	<div class="cs_cczll"><h2>Tombol Body</h2></div>
            	<div class="cs_cczlr">
                	<ul style="padding-top:20px;">
                    	<li>3.5 mm earphone port</li>
                    	<li>Jenis tombol kapasitas </li>
                    </ul>
                </div>
            </div>
            <!--7 结束-->
        ...
        <div class="cs_contar">
        	<div class="bs-sidebar hidden-print" role="complementary">
                  <div class="navbar-wrapper"  id="navbar-example">
                      <div class="navbar navbar-static-top">
                        <div class="container" style="width:100%;">
                          <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav  nav-tabs"  role="tablist">
                                <li class="menuItem active"><a href="#cs_a1">Ukuran dan Lebar</a></li>
                                <li class="menuItem"><a href="#cs_a2">Glass</a></li>
                                <li class="menuItem"><a href="#cs_a3">Kontrol visual</a></li>
                                <li class="menuItem"><a href="#cs_a4">Audio sistem</a></li>
                                <li class="menuItem"><a href="#cs_a5">Mendukung telepon</a></li> 
                                <li class="menuItem"><a href="#cs_a6">Dukungan Bluetooth</a></li> 
                                <li class="menuItem"><a href="#cs_a7">Body material</a></li> 
                            </ul>
                          </div>
                       </div>
                  	  </div>
...
<script src="/assets/stickUp.min.js"></script>
<script src="/assets/jquery.pin.js"></script>

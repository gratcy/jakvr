  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Add New User Group</a></li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('users/users_group_add'); ?>" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" id="inputEmail3" placeholder="Group Name">
                  </div>
                </div>
                <div class="form-group">
      ...
      <tbody>
        ...
        <td><label>Yes <input type="radio" class="uniform" value="1" name="perm[<?php echo $v -> uid?>]"></label>&nbsp;<label> No <input class="uniform" type="radio" value="0" name="perm[<?php echo $v -> uid?>]" checked></label></td>
        </tr>
        <?php endforeach; ?>
      </tbody>
      </table>

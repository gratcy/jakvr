  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Return Detail</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">Return Detail</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Return <?php echo $detail[0] -> tno; ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <?php echo __get_error_msg(); ?>
            
              <table class="table table-bretured table-striped">
                <thead>

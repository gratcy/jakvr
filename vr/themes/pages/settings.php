      ...
      <div class="row">
        <div class="col-xs-12">
           ...
           <div class="box box-info">
			...
			<input type="hidden" name="uid" value="<?php echo $this -> privileges -> sesresult['uid']; ?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="Email" class="col-sm-2 control-label">Email</label>

                  <div class="col-sm-10">
                    <input type="text" name="uemail" class="form-control" id="Email" placeholder="Email" value="<?php echo $this -> privileges -> sesresult['uemail']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="password" name="oldpass" class="form-control" id="OldPassword" placeholder="Old Password">
                  </div>
                </div>
                <div class="form-group">

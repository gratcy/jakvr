  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Add New Color</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
           ...
           <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo site_url('color/color_add'); ?>" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Name</label>

                  <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" id="inputEmail3" placeholder="Color Name">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
					<div id="cp2" class="input-group colorpicker-component">
						<input name="desc" type="text" value="#000000" class="form-control" />

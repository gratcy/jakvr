...
<html lang="id">
  <head>
    ...
    <title>GameSir Indonesia | Hubungi Kami</title>
    ...
    <meta property="og:title" content="GameSir Indonesia | Hubungi Kami" />
        ...
        <div class="collapse navbar-collapse">        
          <ul class="nav navbar-nav navbar-right">
			...
			<li><a href="https://www.tokopedia.com/koekmurah/etalase/gamepad?keyword=gamesir" target="_blank">Tokopedia</a></li>
          	...
          	<li class="active"> <a href="/contact-us" >Hubungi Kami</a></li>
                    </ul>   
        </div><!--/.nav-collapse -->
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            ...
            <h1 class="sidetitle">Hubungi Kami</h1>
            <!-- Categories -->
<div class="col-sm-12">
	<div class="list-group">
	<div class="list-group-item-text" style="color:#8b8b8b;">
<p>Silahkan email ke : adrysunarto@jakvr.com</p>

<!--
<p>Mal Ciputra Lantai 2 Blok U03, Letjen S. Parman, Tj. Duren Utara, Grogol petamburan, Kota Jakarta Barat, Daerah Khusus Ibukota Jakarta, Jakarta, Indonesia 11470</p>
-->

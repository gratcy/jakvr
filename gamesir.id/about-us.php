...
<html lang="id">
  <head>
    ...
    <title>GameSir Indonesia | Tentang Kami</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            ...
            <h1 class="sidetitle">Tentang Kami</h1>
            <!-- Categories -->
<div class="col-sm-12">
	<div class="list-group">
	<div class="list-group-item-text" style="color:#8b8b8b;">
<p>Awalnya kami bukan official GameSir, tetapi karna kami serius memperkenalkan produk ini di Indonesia lambat laun kami menjadi Local Distributon Partnership GameSir di Indonesia (Link <a href="https://gamesir.hk/pages/local-distributor-partnerships" target="_blank">GameSir.hk</a>). Kami menjual produk-produk GameSir di melalui online maupun offline. Untuk online kami biasa menggunakan online store seperti <a href="https://www.tokopedia.com/gamesir">TokoPedia</a>, <a target="_blank" href="https://www.bukalapak.com/gamesir" target="_blank">BukaLapak</a>, <a href="https://shopee.co.id/gamesir" target="_blank">Shopee</a> dan lain sebagainya. Untuk offline kalian bisa langsung dateng ke kantor kami di alamat Citra Garden 1 Blok E1 No.3, Kalideres, Jakarta Barat, 11840, Indonesia.</p>
